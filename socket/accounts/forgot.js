...
export default async (io, socket, args) => {
    ...
    await mail(info.email, "Reset Password", `<h1>Hi, ${info.name}!</h1> <h2>Click <a href="https://arimeisels.com/reset.html?u=${info.username}&c=${md5(info.username + info.password)}">here</a> to reset your password!</h2> <h3>If you did not request to have your password reset, please ignore this email.</h3> <style>* { font-family: sans-serif }</style>`);
