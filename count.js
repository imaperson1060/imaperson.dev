module.exports = (app, cors, query) => {
    app.get("/count/:name", cors(), async (req, res) => {
    ...
    app.post("/count/up/:name/:token", cors(), async (req, res) => {
    ...
    app.get("/count/create/:name", cors(), async (req, res) => {
